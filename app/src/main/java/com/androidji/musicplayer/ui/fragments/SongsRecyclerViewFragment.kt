...
import com.androidji.musicplayer.databinding.FragmentSongsRecyclerViewBinding
import com.androidji.musicplayer.ui.adapters.RvSongsAdapter
import com.androidji.musicplayer.ui.viewModels.MainViewModel

class SongsRecyclerViewFragment : Fragment() {
    lateinit var binding: FragmentSongsRecyclerViewBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSongsRecyclerViewBinding.inflate(inflater)
        return binding.root
    }
    ...
    companion object {
        ...
        fun newInstance(isTopTracks: Boolean) =
            SongsRecyclerViewFragment().apply {
